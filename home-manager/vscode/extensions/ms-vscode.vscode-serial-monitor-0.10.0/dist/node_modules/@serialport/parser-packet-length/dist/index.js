"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.PacketLengthParser=void 0;const stream_1=require("stream");class PacketLengthParser extends stream_1.Transform{constructor(t={}){super(t);const{delimiter:e=170,packetOverhead:s=2,lengthBytes:r=1,lengthOffset:f=1,maxLen:h=255}=t;this.opts={delimiter:e,packetOverhead:s,lengthBytes:r,lengthOffset:f,maxLen:h},this.buffer=Buffer.alloc(0),this.start=!1}_transform(t,e,s){for(let e=0;e<t.length;e++){const s=t[e];if(s===this.opts.delimiter&&(this.start=!0),!0===this.start&&(this.buffer=Buffer.concat([this.buffer,Buffer.from([s])]),this.buffer.length>=this.opts.lengthOffset+this.opts.lengthBytes)){const t=this.buffer.readUIntLE(this.opts.lengthOffset,this.opts.lengthBytes);(this.buffer.length==t+this.opts.packetOverhead||t>this.opts.maxLen)&&(this.push(this.buffer),this.buffer=Buffer.alloc(0),this.start=!1)}}s()}_flush(t){this.push(this.buffer),this.buffer=Buffer.alloc(0),t()}}exports.PacketLengthParser=PacketLengthParser;
// SIG // Begin signature block
// SIG // MIIn4QYJKoZIhvcNAQcCoIIn0jCCJ84CAQExDzANBglg
// SIG // hkgBZQMEAgEFADB3BgorBgEEAYI3AgEEoGkwZzAyBgor
// SIG // BgEEAYI3AgEeMCQCAQEEEBDgyQbOONQRoqMAEEvTUJAC
// SIG // AQACAQACAQACAQACAQAwMTANBglghkgBZQMEAgEFAAQg
// SIG // TRuaN8lvn16FkWUFSJXgbMi5ACsMA66+JSZBBPFTHvag
...
// SIG // SIb3DQEJBDEiBCC04HlD3R2Rm2L277ROWiajrvsScUXQ
// SIG // wZFGWyLhFV13wjBCBgorBgEEAYI3AgEMMTQwMqAUgBIA
// SIG // TQBpAGMAcgBvAHMAbwBmAHShGoAYaHR0cDovL3d3dy5t
// SIG // aWNyb3NvZnQuY29tMA0GCSqGSIb3DQEBAQUABIIBACtb
// SIG // AdWioplS5Ce1kxeh5UL6bzhQ6AtNvaq1qRcQ57ntTk5N
// SIG // IPnXkVIj5PAYHH0TMuIfSjH02PJgR7VJGsOzEkeZjLQV
// SIG // J5KYNyV1sUbXOq+uhaneJfw5wA48VqP81QEznitIpeMH
// SIG // rUMkr/7EDJZpZDkoNu4/HIFHw22IwKxTi4O3qzqePFtV
// SIG // A1d1vg0cm90TUS7XGB3FdS92nMbV11INApjR845KmMU3
// SIG // /srjGVUpzYVF4ISP2Hb5a/iaFo8n2WRkbCjkb3jTEkVC
// SIG // 0qWqnPyTLRBsRLXlCKIK/LC2xncX3jMZ4emNcBdIWxM7
// SIG // yzlt6CgJCz2j2FoW2K36ffR1Dy8zFOehghcpMIIXJQYK
...
// SIG // AwEwMTANBglghkgBZQMEAgEFAAQgIgn9eABkj9VD8gw3
// SIG // EmAO/0UyuF6RxzOs83Uy8bZx3C4CBmRs7zT0qRgTMjAy
// SIG // MzA2MDcxOTE3MTcuNjAzWjAEgAIB9KCB2KSB1TCB0jEL
// SIG // MAkGA1UEBhMCVVMxEzARBgNVBAgTCldhc2hpbmd0b24x
// SIG // EDAOBgNVBAcTB1JlZG1vbmQxHjAcBgNVBAoTFU1pY3