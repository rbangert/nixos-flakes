...
exports.PanelWebview = exports.open_chat_tab = void 0;
...
async function open_chat_tab(question, editor, attach_default, model, model_function = "") {
    await chatTab_1.ChatTab.activate_from_outside(question, editor, attach_default, model, model_function);
}
exports.open_chat_tab = open_chat_tab;
class PanelWebview {
