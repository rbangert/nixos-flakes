...
class PrivacySettings {
    constructor(panel, extensionUri, context) {
        ...
        PrivacySettings._panel.webview.html = PrivacySettings.getHtmlForWebview(PrivacySettings._panel.webview, extensionUri, context);
    }
    static render(context) {
        const panel = vscode.window.createWebviewPanel("refact-privacy-tab", "Refact.ai Privacy Settings", vscode.ViewColumn.One, {
            enableScripts: true,
    ...
    static getHtmlForWebview(webview, extensionUri, cnt) {
        const scriptUri = webview.asWebviewUri(vscode.Uri.joinPath(extensionUri, "assets", "privacy.js"));
        const styleMainUri = webview.asWebviewUri(vscode.Uri.joinPath(extensionUri, "assets", "privacy.css"));
...
PrivacySettings.rules = [
    {
        value: 0,
        name: "Level 0",
        short_description: "Turn off",
        long_description: "Paranoid mode, Refact has no access to your files.",
    },
    {
        value: 1,
        name: "Level 1",
        short_description: "Refact can read your files, but only uses AI models hosted at Refact",
        long_description: "Data will be sent to Refact servers only. We don't collect datasets on the server side. If you use a self-hosting server, your data will be sent only to your server.",
    },
    {
        value: 2,
        name: "Level 2",
